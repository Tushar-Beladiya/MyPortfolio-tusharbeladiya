    ...
    this.state = {
      ...
      projects: [
        ...
        },
        {
          ...
          title: "Clothpair",
          tag: "Angular",
          link: "http://bhavindomadiya.ml/demo6Clothpair/index.html#",
        },
        {
          id: "3",
          preview: Preview3,
          title: "shop.fooodie.tk",
          tag: "NodeJs",
          link: "https://shop.fooodie.tk/",
        },
        {
          id: "4",
          preview: Preview4,
        ...
        },
        {
          ...
          title: "Spendid",
          tag: "React",
          link: "http://bhavindomadiya.ml/demo2Spandid/index.html",
        },
      ],
            ...
            <Col xs={12} sm={12} md={8} lg={9}>
              <div className="portfolio__nav">
                <ul>
                  ...
                  <li
                    className={
                      this.state.pickedFilter === "NodeJs"
                        ? "portfolio__nav-active font12"
                        : "font12"
                    }
                    onClick={() => this.filterGallery("NodeJs")}
                  >
                    NodeJs
                  </li>
                  <li
                    className={
                      this.state.pickedFilter === "Angular"
                        ? "portfolio__nav-active font12"
                        : "font12"
                    }
                    onClick={() => this.filterGallery("Angular")}
                  >
                    Angular
                  </li>
                </ul>
